...
function addMaterial() {
    ...
    cell1.innerHTML = `<th scope="row"><p style="text-align: center; line-height: 2.2em;">${materialIndex}</p></th>`;
    cell2.innerHTML = `<td><input style="margin-top: 3%;" type="input" class="inputt material-id" value="${selectedMaterial.idPart}" id="materialNameRC" name="material_id"></td>`;
    cell3.innerHTML = `<td><input style="margin-top: 2%;" type="input" value="${selectedMaterial.name}"></td>`;
    cell4.innerHTML = `<td><input style="margin-top: 3%;" type="input" list="process" class="inputt1"></td>`;
    cell5.innerHTML = `<td>
                        ...
                        id="usedQuantity-${materialIndex}">
                            <a data-bs-toggle="modal" data-bs-target="#exampleModal1" id="modal-${materialIndex}" data-bs-index="${selectedMaterial.idPart}" >
                                <img style="margin-bottom:1%;" class="imgcalcu" src="/static/images/calculator.png">
                            </a>
                        </td>`;
    cell6.innerHTML = `<td> <p style="text-align: center; line-height: 2.2em;" class="material-price"> ${selectedMaterial.price} </p> </td>`;
    cell7.innerHTML = `<td><input style="margin-top: 3%;" type="input" class="inputt1 material-cost-price" value=0 name="materialCost-${materialIndex}" id=materialCost-${materialIndex}></td>`;
